        ...
        <div className="row">
            <div className="col-md-3 col-6">
                <div className="counter-box position-relative text-center">
                    <h2 className="mb-0 display-2 fw-bold title-dark mt-2 opacity-1"><CountUp start={0} end={10}/></h2>
            ...
            <div className="col-md-3 col-6">
                <div className="counter-box position-relative text-center">
                    <h2 className="mb-0 display-2 fw-bold title-dark mt-2 opacity-1"><CountUp start={0} end={4}/></h2>
            ...
            <div className="col-md-3 col-6">
                <div className="counter-box position-relative text-center">
                    <h2 className="mb-0 display-2 fw-bold title-dark mt-2 opacity-1"><CountUp start={0} end={20}/></h2>
