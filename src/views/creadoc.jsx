                    ...
                    <div className="col-12">
                        <div className="d-flex align-items-center justify-content-between">
                            <ul className="list-unstyled mb-0">
                                <li className="list-inline-item mb-0"><Link href="#" className="text-muted fw-normal"><FiMail className="fea icon-sm text-primary"/> creadoc_support@gmail.com</Link></li>
                            </ul>
                            <ul className="list-unstyled social-icon tagline-social mb-0">
                                ...
                                <li className="list-inline-item mb-0"><Link to={'https://www.instagram.com/creadoc.co'}><BiLogoInstagram className="mb-0 icon"/></Link></li>
                ...
                <div className="row justify-content-center mt-5">
                    <div className="col-12">
                        <div className="title-heading text-center">
                            ...
                            <p className="para-desc text-white-50 mb-0 mx-auto">Launch your campaign and benefit from our expertise on designing and managing conversion centered react.jsx page.</p>
                ...
                <div className="row justify-content-center">
                    <div className="col">
                        <div className="section-title text-center mb-4 pb-2">
                            ...
                            <p className="text-muted para-desc mb-0 mx-auto">Start working with Creadoc that can provide everything you need to generate awareness, drive traffic, connect.</p>
                        </div>
                    </div>
                </div>
                <Clients/>
                        ...
                        return(
                            <div className="col-lg-2 col-md-2 col-6 py-2" key={index}>
                                <div className="text-center">
                                    <img src={item} width={114} height={80} className="avatar avatar-md-md w-auto" alt=""/>
                                </div>
                            </div>
                        )
                    })}
                ...
                <div className="row mt-lg-4 align-items-center">
                    <div className="col-lg-5 col-md-12 text-center text-lg-start">
                        <div className="section-title mb-4 mb-lg-0 pb-2 pb-lg-0">
                            ...
                            <p className="text-muted para-desc mx-auto mb-0">Start working with Creadoc that can provide everything you need to generate awareness, drive traffic, connect.</p>
